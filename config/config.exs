...
config :recipes_bot, RecipesBotWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: RecipesBotWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: RecipesBot.PubSub,
  live_view: [signing_salt: "43i+TDUa"]
...
config :recipes_bot, RecipesBot.Mailer, adapter: Swoosh.Adapters.Local
