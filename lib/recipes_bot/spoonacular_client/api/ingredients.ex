...
defmodule RecipesBot.SpoonacularClient.Api.Ingredients do
  @moduledoc """
  ...
  """
  @spec autocomplete_ingredient_search(Tesla.Env.client(), keyword()) ::
          {:ok, nil}
          | {:ok,
             list(
               RecipesBot.SpoonacularClient.Model.AutocompleteIngredientSearch200ResponseInner.t()
             )}
          | {:error, Tesla.Env.t()}
  def autocomplete_ingredient_search(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%RecipesBot.SpoonacularClient.Model.AutocompleteIngredientSearch200ResponseInner{}]},
      {401, false},
      {403, false},
      {404, false}
    ])
  ...
  {:ok, RecipesBot.SpoonacularClient.Model.ComputeIngredientAmount200Response.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec compute_ingredient_amount(Tesla.Env.client(), float(), String.t(), float(), keyword()) ::
          {:ok, nil}
          | {:ok, RecipesBot.SpoonacularClient.Model.ComputeIngredientAmount200Response.t()}
          | {:error, Tesla.Env.t()}
  def compute_ingredient_amount(connection, id, nutrient, target, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, %RecipesBot.SpoonacularClient.Model.ComputeIngredientAmount200Response{}},
      {401, false},
      {403, false},
      {404, false}
    ])
  ...
  {:ok, RecipesBot.SpoonacularClient.Model.GetIngredientInformation200Response.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec get_ingredient_information(Tesla.Env.client(), integer(), keyword()) ::
          {:ok, nil}
          | {:ok, RecipesBot.SpoonacularClient.Model.GetIngredientInformation200Response.t()}
          | {:error, Tesla.Env.t()}
  def get_ingredient_information(connection, id, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, %RecipesBot.SpoonacularClient.Model.GetIngredientInformation200Response{}},
      {401, false},
      {403, false},
      {404, false}
    ])
  ...
  {:ok, RecipesBot.SpoonacularClient.Model.GetIngredientSubstitutes200Response.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec get_ingredient_substitutes(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, RecipesBot.SpoonacularClient.Model.GetIngredientSubstitutes200Response.t()}
          | {:error, Tesla.Env.t()}
  def get_ingredient_substitutes(connection, ingredient_name, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, %RecipesBot.SpoonacularClient.Model.GetIngredientSubstitutes200Response{}},
      {401, false},
      {403, false},
      {404, false}
    ])
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec get_ingredient_substitutes_by_id(Tesla.Env.client(), integer(), keyword()) ::
          {:ok, nil}
          | {:ok, RecipesBot.SpoonacularClient.Model.GetIngredientSubstitutes200Response.t()}
          | {:error, Tesla.Env.t()}
  ...
  {:ok, RecipesBot.SpoonacularClient.Model.IngredientSearch200Response.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec ingredient_search(Tesla.Env.client(), keyword()) ::
          {:ok, nil}
          | {:ok, RecipesBot.SpoonacularClient.Model.IngredientSearch200Response.t()}
          | {:error, Tesla.Env.t()}
  def ingredient_search(connection, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, %RecipesBot.SpoonacularClient.Model.IngredientSearch200Response{}},
      {401, false},
      {403, false},
      {404, false}
    ])
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec map_ingredients_to_grocery_products(
          Tesla.Env.client(),
          RecipesBot.SpoonacularClient.Model.MapIngredientsToGroceryProductsRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok,
             list(
               RecipesBot.SpoonacularClient.Model.MapIngredientsToGroceryProducts200ResponseInner.t()
             )}
          | {:error, Tesla.Env.t()}
  def map_ingredients_to_grocery_products(
    ...
    |> evaluate_response([
      {200,
       [%RecipesBot.SpoonacularClient.Model.MapIngredientsToGroceryProducts200ResponseInner{}]},
      {401, false},
      {403, false},
      {404, false}
    ])
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec visualize_ingredients(Tesla.Env.client(), keyword()) ::
