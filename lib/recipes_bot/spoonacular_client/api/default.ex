...
defmodule RecipesBot.SpoonacularClient.Api.Default do
  @moduledoc """
  ...
  @spec analyze_recipe(
          Tesla.Env.client(),
          RecipesBot.SpoonacularClient.Model.AnalyzeRecipeRequest.t(),
          keyword()
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec create_recipe_card_get(Tesla.Env.client(), float(), keyword()) ::
          {:ok, nil} | {:ok, Map.t()} | {:error, Tesla.Env.t()}
  ...
  {:ok, RecipesBot.SpoonacularClient.Model.SearchRestaurants200Response.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec search_restaurants(Tesla.Env.client(), keyword()) ::
          {:ok, nil}
          | {:ok, RecipesBot.SpoonacularClient.Model.SearchRestaurants200Response.t()}
          | {:error, Tesla.Env.t()}
  def search_restaurants(connection, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, %RecipesBot.SpoonacularClient.Model.SearchRestaurants200Response{}},
      {401, false},
      {403, false},
      {404, false}
    ])
